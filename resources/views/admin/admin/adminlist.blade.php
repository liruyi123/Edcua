                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                @foreach($data as $k=>$v)
                                    <tr >
                                        <input type="hidden" class="cate_id" aid="{{$v['admin_id']}}">
                                        <td>{{$v['admin_id']}}</td>
                                        <td>{{$v['admin_name']}}</td>
                                        <td>{{$v['admin_tel']}}</td>
                                        <td>{{$v['admin_email']}}</td>
