                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                @foreach($arr['data'] as $k=>$v)
                                    <tr >
                                        <input type="hidden" class="cate_id" cid="{{$v['cou_id']}}">
                                        <td>{{$v['cou_id']}}</td>
                                        <td>{{$v['cou_name']}}</td>
                                        <td>
                                            @if($v['is_show'] == 1)
